...
function App(): JSX.Element {
  return (
    ...
    <Place 
      ...
      place={'Makati City'}
      country={'Philippines'}
      imageURL={'https://images.unsplash.com/photo-1597285952775-1382215fbff0?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1374&q=80'}
